...
\begin{itemize}[label=\textbullet, leftmargin=1em]
    \item \textbf{Focus:} Transcriptomics data analysis, multi-omics integration, and bioinformatics pipeline development.
    \item \textbf{Core Stack:} R (Bioconductor, Tidymodels), Python (Pandas, JAX, Scikit-learn), Nextflow (DSL2), BASH.
    \item \textbf{Current Objective:} Applying rigorous mathematical and programming skills in single-cell and spatial transcriptomics to advance research in oncology and tumor biology.
\end{itemize}
...
\cvstrength{\faAward}
           ...
           {Bridged physical science expertise with modern biological workflows. Skilled in complex multidimensional array operations, JAX/GPU acceleration, sequence alignment, and multivariate statistical modeling for multi-omics using R (Bioconductor) and Python.}
...
\cvskills{Bioinformatics}
         {Nextflow (DSL2), scRNA-seq \& Spatial Transcriptomics Concepts, NGS Analysis, Multiple Sequence Alignment (MAFFT), Sequence Trimming (trimAl), NCBI / Entrez}
