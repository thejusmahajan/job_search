...
Computational Scientist (PhD) with 5+ years of experience in \textbf{large-scale data analysis}, \textbf{statistical modeling}, and \textbf{pipeline development}. Trained in \textbf{R (Bioconductor, Tidymodels)} and \textbf{Python (Pandas, NumPy, Scikit-learn, JAX)} for high-dimensional data analysis. Built a viral genomics pipeline using \textbf{Nextflow (DSL2)}. Currently deepening skills in data pipeline development, \textbf{transcriptomics}, AI/machine learning, and NGS analysis through specialized training and an industry internship. Eager to develop expertise in \textbf{single-cell and spatial transcriptomics} and apply my rigorous mathematical and programming skills to advance research in \textbf{oncology, tumor biology, and customized precision medicine}.
