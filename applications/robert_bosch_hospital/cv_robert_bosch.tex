...
\cvheader{Thejus Mahajan Ph.D.}
         {Bioinformatics \& Multi-Omics Researcher}
         {+49-15259697629}
...
\cvstrength{\faAward}
           ...
           {Bridged physical science expertise with modern biomedical workflows. Skilled in high-dimensional data analysis, JAX/GPU acceleration, and multivariate statistical modeling for multi-omics integration (transcriptomics, genomics, metabolomics) using R (Bioconductor) and Python.}
