...
\cvheader{Thejus Mahajan Ph.D.}
         {Computational Biologist --- Scientific Computing \& AI}
         {+49-15259697629}
...
\begin{itemize}[label=\textbullet, leftmargin=1em]
    \item \textbf{Focus:} Reproducible computational workflows, scientific computing (JAX/PyTorch), and AI-driven single-cell analysis.
    \item \textbf{Core Stack:} Python (JAX, PyTorch concepts, Scikit-learn, Pandas), R (Bioconductor, Tidymodels), Nextflow (DSL2), BASH.
    \item \textbf{Current Objective:} Driving methodological standards and mentoring interdisciplinary teams in computational biology to advance translational biomedicine.
\end{itemize}
...
\cvstrength{\faAward}
           {Scientific Computing \& Mentorship}
           {Bridged physical science computing with modern biomedical workflows. Experienced in mentoring and coordinating interdisciplinary teams. Deep expertise in JAX/GPU-accelerated computing, reproducible single-cell pipelines, and multivariate statistical modeling used to elevate lab-wide methodological standards.}
...
\cvskills{Bioinformatics}
         {Single-Cell \& Transcriptomics Concepts, Nextflow (DSL2), NGS Analysis, Multiple Sequence Alignment (MAFFT), Sequence Trimming (trimAl), NCBI / Entrez}

\cvskills{Scientific Computing \& ML}
         {Google JAX (TPU/GPU), PyTorch \& TensorFlow concepts, Scikit-learn, Tidymodels, PCA, Clustering, Multivariate Analysis}
