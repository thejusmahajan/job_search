...
\begin{itemize}[label=\textbullet, leftmargin=1em]
    ...
    \item \textbf{Current Objective:} Applying reproducible computational workflows and AI methodologies to advance translational collaborations in biomedicine.
\end{itemize}
