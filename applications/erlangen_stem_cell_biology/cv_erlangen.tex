...
\begin{itemize}[label=\textbullet, leftmargin=1em]
    \item \textbf{Focus:} Large-scale data analysis, bioinformatics pipeline development, and statistical modeling.
    \item \textbf{Core Stack:} R (Bioconductor, Tidymodels), Python (Pandas, JAX, Scikit-learn), Nextflow (DSL2), BASH.
    \item \textbf{Current Objective:} Applying computational and machine learning expertise in single-cell multi-omics to advance research in stem cell biology.
\end{itemize}
