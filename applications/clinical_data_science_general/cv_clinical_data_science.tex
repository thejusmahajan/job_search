...
\begin{itemize}[label=\textbullet, leftmargin=1em]
    ...
    \item Open to: Biostatistics, Clinical Data Science, and Bioinformatics roles in Hamburg, Berlin, or remote (DACH).
\end{itemize}
...
\cvlanguage{German}{B1 (Goethe-Zertifikat), B2-Pr\"ufung angemeldet / scheduled}{3}
